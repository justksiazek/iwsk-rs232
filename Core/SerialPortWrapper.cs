...
namespace Core
{
    public class SerialPortWrapper {
        ...
        public string Name {
            ...
            set { this._port.PortName = value; }
        }
        public int BaudRate {
            get { return this._port.BaudRate; }
            set { this._port.BaudRate = value; }
        }
        public Parity Parity {
            get { return this._port.Parity; }         
            set { this._port.Parity = value; }
        }
        public int DataBits {
            get { return this._port.DataBits; }
            set { this._port.DataBits = value; }
        }
        public StopBits StopBits {
            get { return this._port.StopBits; }
            set { this._port.StopBits = value; }
        }
        public Handshake Handshake {
            get { return this._port.Handshake; }
            set { this._port.Handshake = value; }
        }
        public int ReadTimeout {
            get { return this._port.ReadTimeout; }
            set { this._port.ReadTimeout = value; }
        }
        public int WriteTimeout {
            get { return this._port.WriteTimeout; }
            set { this._port.WriteTimeout = value; }
        }
        private string _stopCharacters;
        public string StopCharacters {
            get { return this._stopCharacters; }
            set { this._stopCharacters = value; }
        }

        public bool DTR {
            get { return this._port.DtrEnable; }
            set { this._port.DtrEnable = value; }
        }
        public bool DSR {
            get { return this._port.DsrHolding; }
        }
        public bool RTS {
            get { return this._port.RtsEnable; }
            set { this._port.RtsEnable = value; }
        }
        public bool CTS {
            get { return this._port.CtsHolding; }
        }
        public bool CD {
            get { return this._port.CDHolding; }
        }
